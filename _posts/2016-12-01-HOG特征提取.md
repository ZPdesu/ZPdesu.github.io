...
![这里写图片描述](/images/Image-test.jpg)

![这里写图片描述](/images/Image-test3.jpg)
...
![这里写图片描述](/images/result2.png)
可以看出增大cell的size得到的特征图更加注重基本轮廓和边缘，而忽略一些细节，某种程度上降低了噪声。

通道数目为16个方向

![这里写图片描述](/images/result3.png)
